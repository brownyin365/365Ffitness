<template>
  ...
  <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
    <h2 class="text-3xl leading-9 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
      ...
      <p class="text-gray-600 text-xl">We invite you to come in and get comfortable with the space, the team, and the culture. We want to listen to you, understand your goals and give guidance if you feel stuck. We offer an atmosphere that is fueled from positive vibes and high power energy.  Join us today -- NO CONTRACTS!</p>
    </h2>
